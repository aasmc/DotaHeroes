...
class FilterHerosTest {
    ...
    fun searchHeroByName(){
        filterHeros = FilterHeroes()

        // Execute use-case
        val emissions = filterHeros.execute(
            current = heroList,
            heroName = "Slark",
            heroFilter = HeroFilter.HeroOrder(),
    ...
    fun orderByNameDesc(){
        ...
        val emissions = filterHeros.execute(
            current = heroList,
            heroName = "",
            heroFilter = HeroFilter.HeroOrder(order = FilterOrder.Descending),
            attributeFilter = HeroAttribute.Unknown,
        )
    ...
    fun orderByNameAsc(){
        ...
        val emissions = filterHeros.execute(
            current = heroList,
            heroName = "",
            heroFilter = HeroFilter.HeroOrder(order = FilterOrder.Ascending),
            attributeFilter = HeroAttribute.Unknown,
        )
